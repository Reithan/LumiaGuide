...
summons["Snare"] = new SummonStats("Snare","Common",2,5,null,"Root",0.5,10,[["Dock",4],["Pond",6],["Beach",3],["Archery Range",5],["Forest",5],["Chapel",4]],null,[["Wild Boar","Rarely"]]);
...
summons["Enhanced Mousetrap"] = new SummonStats("Enhanced Mousetrap","Uncommon",2,5,new ItemRecipe("Mousetrap","Iron Ore"),null,null,160,null,null,null,["Green"]);
...
summons["Jungle Guillotine"] = new SummonStats("Jungle Guillotine","Uncommon",1,5,new ItemRecipe("Mousetrap","Kitchen Knife"),"Root",0.5,100,null,null,null,["Green"]);
summons["Explosive Trap"] = new SummonStats("Explosive Trap","Uncommon",1,5,new ItemRecipe("Mousetrap","Gunpowder"),"Delay",1.5,180,null,null,null,["Green"]);
...
summons["Double Guillotine"] = new SummonStats("Double Guillotine","Epic",2,5,new ItemRecipe("Jungle Guillotine","Pendulum Axe"),"Root",1,340,null,null,null,["Purple"]);
